...
class StringOperations
	...
	'******************************************************************************************************************
	'' @SDESCRIPTION:	writes a value to the output.
	...
	public function writeDebug(value)
		if consts.isDevelopment() then write(value)
	end function
	...
	'******************************************************************************************
	'' @SDESCRIPTION: 	provides "N/A" if the field beeing passed equals empty
	'' @PARAM:			txt [string]: the text
	'' @RETURN:			[string] eighter "N/A" if the field txt is empty or the txt itself
	'******************************************************************************************
	public function NAIfEmpty(txt)
		NAIfEmpty = lib.iif((txt & "") = "", consts.NA, txt)
	end function
...
lib.registerClass("StringOperations")
%>
