...
class Logger
	...
	public sub class_initialize()
		...
		if logLevel = -1 and consts.isDevelopment() then logLevel = 1
		if logLevel = -1 and not consts.isDevelopment() then logLevel = 8
	end sub
	...
	public property get logfile ''[string] gets the full path and name of the logfile
		logfile = path & p_prefix & lCase(consts.env) & extension
	end property
	...
	'' @PARAM:			stlye [string]: ansi style and color code. check details at http://en.wikipedia.org/wiki/ANSI_escape_code
