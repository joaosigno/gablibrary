...
'' @CLASSTITLE:		md5Algorithm
'' @CREATOR:		Michal Gabrukiewicz - gabru @ grafix.at
'' @CREATEDON:		15.09.2003
'' @CDESCRIPTION:	Thats a class for MD5 encryption. Its a class for encryption-class, but it can be used alone also.
...
class md5Algorithm
	...
	'**********************************************************************************************************************
	'' @SDESCRIPTION:	Encrypts a string with the MD5 algorithm
