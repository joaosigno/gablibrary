...
const PAGING_AMOUNT_OF_NUMBERS		= 10												'how many page numbers will be displayed at once
const SELECTEDBGCOLOR				= "#CCCCCC"											'The backgroundcolor when a radiobutton has been clicked
const SELECTEDCOLOR					= "#000000"											'The color when a radiobutton has been clicked
const ROW_COLOR_1					= "#F1EEF6"
const ROW_COLOR_2					= "#FFFFFF"
const ROW_COLOR_HOVER				= "#FCF1A7"
